...
const FALLBACK_SERVICE_PROVIDERS: ServiceProvider[] = [
  ...
  storeProvider(FALLBACK_STORE_PROFILES[1], 'GRADE', {
    serviceTypes: ['Professional grading', 'Sub-grades', 'Slab authentication'],
    description:
      'kaido99 Grading handles monthly PSA/BGS batch submissions for Thai collectors. We inspect, prep, submit and return slabs with full tracking inside your SWS vault.',
    deliveryMode: 'PHYSICAL_SHIP',
    ...
    faq: [
      { q: 'Which graders do you use?', a: 'We primarily submit to PSA and BGS.' },
      { q: 'Is shipping insured?', a: 'Yes, both domestic and international legs are insured.' },
    ],
    packages: [
      {
        id: 'kaido99-grade-psa',
        providerId: 's1-grade',
        name: 'PSA Economy',
        description: 'Standard PSA grading with estimated 4–6 week turnaround.',
        deliveryMode: 'PHYSICAL_SHIP',
        turnaround: '4–6 weeks',
        pricePerCard: 1100,
        currency: 'THB',
        includes: ['Inspection & prep', 'PSA submission', 'Return shipping', 'Vault tracking'],
        imageUrl: getPackagePlaceholderUrl('kaido99-grade-psa'),
        enabled: true,
      },
      {
        id: 'kaido99-grade-bgs',
        providerId: 's1-grade',
        name: 'BGS with Sub-grades',
        description: 'Beckett grading with sub-grades for centering, edges, corners and surface.',
        deliveryMode: 'PHYSICAL_SHIP',
        turnaround: '6–10 weeks',
        pricePerCard: 1500,
        currency: 'THB',
        includes: ['Inspection & prep', 'BGS submission with sub-grades', 'Return shipping', 'Vault tracking'],
        imageUrl: getPackagePlaceholderUrl('kaido99-grade-bgs'),
        enabled: true,
      },
    ],
  }),
  storeProvider(FALLBACK_STORE_PROFILES[3], 'GRADE', {
    serviceTypes: ['Professional grading', 'Sealed-box authentication'],
    description:
      'nami_swan Grading is based in Chiang Mai and specializes in graded slabs and sealed-box authentication. Drop-off or insured ship-in accepted.',
    deliveryMode: 'PHYSICAL_SHIP',
    ...
    packages: [
      {
        id: 'nami_swan-grade-standard',
        providerId: 's3-grade',
        name: 'Standard Grading',
        description: 'Professional grading submission with full condition check before send-out.',
        deliveryMode: 'PHYSICAL_SHIP',
        turnaround: '4–8 weeks',
        pricePerCard: 1200,
        currency: 'THB',
        includes: ['Pre-submission check', 'Grader submission', 'Return shipping', 'Vault update'],
        imageUrl: getPackagePlaceholderUrl('nami-grade-standard'),
        enabled: true,
      },
    ],
  }),
