  ...
  theme: {
    extend: {
      colors: {
        ...
        "surface-dark": "#0D0F26",
        // Buyer-compatible semantic token bridge (mapped to dark host)
        ...
        "brand-secondary-dark": "var(--color-brand-secondary-dark)",
        success: {
      ...
      backgroundImage: {
        "brand-gradient": "linear-gradient(135deg, #F06AA8 0%, #7B8AF5 100%)",
      },
    },
  },
